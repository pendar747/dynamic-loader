...
test('resolves relative modules correctly', t => {
    const project = new Project(
        new Path('/Users/penda/projects/vue-designer'));
    const file = new Path('/Users/penda/projects/vue-designer/foo.js');
    ...
    if (dep) {
        ...
        t.true(dep.isEqualTo(
            new Path('/Users/penda/projects/vue-designer/bar.js')));
    }
...
test('resolves absolute modules correctly', t => {
    ...
    if (dep2) {
        t.pass('dep2 is defined');
        t.true(dep2.isEqualTo( 
            new Path('/Users/penda/projects/vue-designer/node_modules/' +
            'moment/main.js')));
    }
...
test('gets the right path for node modules', t => {
    const project = new Project(new Path('/Users/foo'));
    t.true(project.nodeModulesPath.isEqualTo(
        new Path('/Users/foo/node_modules')));
});